...
<table class="table table-borderet">
    ...
    <body>
        <tr>
            ...
            <td>
                <a href="?p=edit_barang"class="btn-md btn-primary"><span class="glyphicon glyphicon-edit"></span></a>
                <a href=""class="btn-md btn-danger"><span class="glyphicon glyphicon-trash"></span></a>
            </td>
        </tr>
    </body>
</table>
